...
namespace WebDataAnalysis.Infrastructure.Migrations
{
    ...
    [Migration("20250629160338_AddStatusAndCategory")]
    partial class AddStatusAndCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebDataAnalysis.Domain.Entity.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebDataAnalysis.Domain.Entity.Device", b =>
                {
                    ...
                    b.Property<Guid?>("StatusDeviceId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebDataAnalysis.Domain.Entity.StatusDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebDataAnalysis.Domain.Entity.Device", b =>
                {
                    b.HasOne("WebDataAnalysis.Domain.Entity.Category", "Category")
                        .WithMany("Devices")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WebDataAnalysis.Domain.Entity.StatusDevice", "StatusDevice")
                        .WithMany("Devices")
                        .HasForeignKey("StatusDeviceId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("Category");

                    b.Navigation("StatusDevice");
                });
